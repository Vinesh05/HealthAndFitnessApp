...
class FoodDietPlanAdapter(private val foodList: ArrayList<Food>, private val context: Context): RecyclerView.Adapter<FoodDietPlanAdapter.FoodDietPlanViewHolder>() {
